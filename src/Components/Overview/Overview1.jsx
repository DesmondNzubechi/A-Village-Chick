...
<h1 className="text-slate-900 capitalize md:hidden md:text-[45px] leading-[45px] md:leading-[50px] text-[40px]   font-myfont">Invest in your relationship with yourself</h1>
  ...
  <div data-aos='fade-up' data-aos-duration='1000' className="flex-start flex flex-col gap-4">
    ...
    <p className="md:text-[20px] text-slate-800 text-[18px] ">We all have a tendency to put others first, but in doing so, we can sometimes neglect our relationship with ourselves. Let me be your advocate and show you a kinder, gentler way to treat the most important person in your life.</p>
  </div>
