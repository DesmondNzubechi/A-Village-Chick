            ...
            if (e.target.tagName === 'SPAN') {
                setAccount({
                  ...
                  <p onClick={() => {
                    ...
                    <input className="outline-0  w-full border font-[300] text-[20px] p-2 rounded " type="text" placeholder="email address" name="email" id="" />
                  <input className="outline-0 w-full border font-[300]  text-[20px] p-2 rounded " type="password" placeholder="password" name="" id="" />
                  <button className="bg-slate-900 hover:bg-slate-600 text-slate-50 text-[20px] w-full p-2 rounded ">Login</button>
