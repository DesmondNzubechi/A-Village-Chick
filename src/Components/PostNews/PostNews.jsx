            ...
            <div className="flex flex-col gap-5">
              <div className="flex flex-col gap-5 md:flex-row  ">
                <div className="flex flex-col gap-0 ">
                    <label className="uppercase font-semibold text-[20px] " htmlFor="headline">news headline :</label>
                ...
                <div className="flex flex-col gap-0 ">
                    <label className="uppercase font-semibold text-[20px] " htmlFor="headline">news image/video :</label>
                ...
                <div className="flex flex-col gap-0 ">
                    <label className="uppercase font-semibold text-[20px] " htmlFor="headline">Date :</label>
              ...
              <div className="flex gap-0 flex-col">
                <label className="uppercase font-bold text-[20px] "  htmlFor="full content">Full content</label>
