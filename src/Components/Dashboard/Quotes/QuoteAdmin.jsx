...
export const AdminQuote = () => {
   ...
   useEffect(() => {
    ...
    return(
       Reviewed?.quoter && <div className="px-[40px] flex justify-center font-poppins py-[100px]">
            <div>
   ...
   <div className="flex justify-center items-center gap-[20px] ">
    ...
    <div className="mt-5">
        ...
        <button onClick={() => deleteQuote(Reviewed?.quote)} className="bg-red-300 p-1 hover:bg-red-500 rounded text-slate-900">Delete Quote</button>
    </div>
    </div>
